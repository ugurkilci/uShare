<?php
	...
	function ushare($usharea) {
		...
		$ushc = array("http://www.facebook.com/share.php?u=http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'],"https://twitter.com/home?status=http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'],"https://plus.google.com/share?url=http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'],"https://pinterest.com/pin/create/button/?url=http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'],"https://www.linkedin.com/shareArticle?mini=true&url=http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI']."&source=http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'],"http://vk.com/share.php?url=".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'],"http://ok.ru/share.php?url=".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'],"http://www.stumbleupon.com/submit?url=".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'],"http://www.reddit.com/submit?url=http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'],"http://www.tumblr.com/share/link?url=http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'],"https://www.blogger.com/blog-this.g?u=http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI']."&t=http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'],"http://github.com/ushare#ref=uShare","http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'],"http://www.facebook.com/share.php?u=","https://twitter.com/home?status=","https://plus.google.com/share?url=","https://pinterest.com/pin/create/button/?url=","https://www.linkedin.com/shareArticle?mini=true&url=","http://vk.com/share.php?url=","http://ok.ru/share.php?url=","http://www.stumbleupon.com/submit?url=","http://www.reddit.com/submit?url=","http://www.tumblr.com/share/link?url=","https://www.blogger.com/blog-this.g?u=");

<?php
	...
	function ushare($usharea) {
		...
		$ushb = array('fb','twt','gpls','pin','lin','vk','okru','su','rddt','tmblr','blggr','i.n.f.o','uhstlnk');
		...
		"https://github.com/ugurkilci/uShare&ref=uShare","http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI']");
